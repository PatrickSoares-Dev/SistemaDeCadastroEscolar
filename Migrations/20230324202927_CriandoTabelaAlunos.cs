        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qtd_Alunos = table.Column<int>(type: "int", nullable: false),
                    EscolaID_Escola = table.Column<int>(type: "int", nullable: true),
                    TurmaNome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EscolaNome = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
